...
function updateGallery(objGallery, nameOfArtwork, newValue) {
  for (let key in objGallery) {
    if (key === nameOfArtwork) {
      objGallery[key] = newValue;
    }
    else {
      objGallery[nameOfArtwork] = newValue;
    }
  }
  return objGallery;
}
